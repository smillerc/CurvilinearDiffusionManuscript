...
∂u∂t = (
	    f_ξ² * (aᵢ₊½ * (uⁿ⁺¹ᵢ₊₁ⱼₖ - uⁿ⁺¹ᵢⱼₖ) - aᵢ₋½ * (uⁿ⁺¹ᵢⱼₖ - uⁿ⁺¹ᵢ₋₁ⱼₖ)) +
	    f_η² * (aⱼ₊½ * (uⁿ⁺¹ᵢⱼ₊₁ₖ - uⁿ⁺¹ᵢⱼₖ) - aⱼ₋½ * (uⁿ⁺¹ᵢⱼₖ - uⁿ⁺¹ᵢⱼ₋₁ₖ)) +
	    f_ζ² * (aₖ₊½ * (uⁿ⁺¹ᵢⱼₖ₊₁ - uⁿ⁺¹ᵢⱼₖ) - aₖ₋½ * (uⁿ⁺¹ᵢⱼₖ - uⁿ⁺¹ᵢⱼₖ₋₁)) +
	    
		+f_ξη * (
	      aᵢ₊₁ⱼₖ * (uⁿ⁺¹ᵢ₊₁ⱼ₊₁ₖ - uⁿ⁺¹ᵢ₊₁ⱼ₋₁ₖ) - # ∂u/∂η
	      aᵢ₋₁ⱼₖ * (uⁿ⁺¹ᵢ₋₁ⱼ₊₁ₖ - uⁿ⁺¹ᵢ₋₁ⱼ₋₁ₖ)   # ∂u/∂η
	    ) + # ∂/∂ξ
	    +f_ξη * (
	      aᵢⱼ₊₁ₖ * (uⁿ⁺¹ᵢ₊₁ⱼ₊₁ₖ - uⁿ⁺¹ᵢ₋₁ⱼ₊₁ₖ) - # ∂u/∂ξ
	      aᵢⱼ₋₁ₖ * (uⁿ⁺¹ᵢ₊₁ⱼ₋₁ₖ - uⁿ⁺¹ᵢ₋₁ⱼ₋₁ₖ)   # ∂u/∂ξ
	    ) + # ∂/∂η
	    
		+f_ζη * (
	      aᵢⱼₖ₊₁ * (uⁿ⁺¹ᵢⱼ₊₁ₖ₊₁ - uⁿ⁺¹ᵢⱼ₋₁ₖ₊₁) - # ∂u/∂η
	      aᵢⱼₖ₋₁ * (uⁿ⁺¹ᵢⱼ₊₁ₖ₋₁ - uⁿ⁺¹ᵢⱼ₋₁ₖ₋₁)   # ∂u/∂η
	    ) + # ∂/∂ζ
		+f_ζη * (
	      aᵢⱼ₊₁ₖ * (uⁿ⁺¹ᵢⱼ₊₁ₖ₊₁ - uⁿ⁺¹ᵢⱼ₊₁ₖ₋₁) - # ∂u/∂ζ
	      aᵢⱼ₋₁ₖ * (uⁿ⁺¹ᵢⱼ₋₁ₖ₊₁ - uⁿ⁺¹ᵢⱼ₋₁ₖ₋₁)   # ∂u/∂ζ
	    ) + # ∂/∂η
	    
		+f_ζξ * (
	      aᵢⱼₖ₊₁ * (uⁿ⁺¹ᵢ₊₁ⱼₖ₊₁ - uⁿ⁺¹ᵢ₋₁ⱼₖ₊₁) - # ∂u/∂ξ
	      aᵢⱼₖ₋₁ * (uⁿ⁺¹ᵢ₊₁ⱼₖ₋₁ - uⁿ⁺¹ᵢ₋₁ⱼₖ₋₁)   # ∂u/∂ξ
	    ) + # ∂/∂ζ
	    +f_ζξ * (
	      aᵢ₊₁ⱼₖ * (uⁿ⁺¹ᵢ₊₁ⱼₖ₊₁ - uⁿ⁺¹ᵢ₊₁ⱼₖ₋₁) - # ∂u/∂ζ
	      aᵢ₋₁ⱼₖ * (uⁿ⁺¹ᵢ₋₁ⱼₖ₊₁ - uⁿ⁺¹ᵢ₋₁ⱼₖ₋₁)   # ∂u/∂ζ
	    ) + # ∂/∂ξ
		
	    aᵢⱼₖ * α / 2 * (uⁿ⁺¹ᵢ₊₁ⱼₖ - uⁿ⁺¹ᵢ₋₁ⱼₖ) +
	    aᵢⱼₖ * β / 2 * (uⁿ⁺¹ᵢⱼ₊₁ₖ - uⁿ⁺¹ᵢⱼ₋₁ₖ) +
	    aᵢⱼₖ * γ / 2 * (uⁿ⁺¹ᵢⱼₖ₊₁ - uⁿ⁺¹ᵢⱼₖ₋₁)
  	) + s

# ╔═╡ 64570323-0ae1-496b-945a-fe4a1228ec2b
# A_coeff =  (uⁿ⁺¹ᵢⱼ - uⁿᵢⱼ) * Δt⁻¹  + (∂u∂t)
f_uⁿ⁺¹ =  (∂u∂t) - s

# ╔═╡ fceac742-c1a1-4ff4-9f4e-98b44498b626
A_coeff = uⁿ⁺¹ᵢⱼₖ - f_uⁿ⁺¹ * Δt
...
git-tree-sha1 = "81dab983a0203f835f9d6dec348f200a4979c755"
