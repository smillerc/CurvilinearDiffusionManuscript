...
∂u∂t = 
	    ...
	    aᵢⱼ * .5α * (uⁿ⁺¹ᵢ₊₁ⱼ - uⁿ⁺¹ᵢ₋₁ⱼ) +
	    aᵢⱼ * .5β * (uⁿ⁺¹ᵢⱼ₊₁ - uⁿ⁺¹ᵢⱼ₋₁) + s
  	

# ╔═╡ a793b86f-de3c-408e-8b87-2d2c42634999
md"""
Use backward Euler to discretize

$\frac{u^{n+1}_i - u^{n}_i}{\Delta t} = \frac{\partial u}{\partial t}$
"""
...
md"""
`A_coeff` is the $A$ coefficient matrix
"""

# ╔═╡ 8f3cadd0-b343-4d62-98f6-84dc744a9ad5
A_coeff = uⁿ⁺¹ᵢⱼ - f_uⁿ⁺¹ * Δt

# ╔═╡ 23fbf92c-b625-45a0-9cf5-0617c05a97cb
simplify(A_coeff; expand=true)
